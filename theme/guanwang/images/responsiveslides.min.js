...
(function(c, I, B) {
    c.fn.responsiveSlides = function(l) {
        ...
        return this.each(function() {
            ...
            w = d + "_s", k = c("<div class='" + g + "_tabs " + d + "_tabs' />"), x = {
                "float": "left",
                position: "relative",
                opacity: 1,
                zIndex: 2
            ...
            if (1 < e.size()) {
                ...
                if (a.pager && !a.manualControls) {
                    ...
                    e.each(function(a) {
                        a += 1;
                        A += "<span><a href='#' class='" + w + a + "'>" + a + "</a></span>"
                    });
                    k.append(A);
                ...
                (a.pager || a.manualControls) && k.find("span").each(function(a) {
                ...
                if (a.pager || a.manualControls)
                    ...
                    k.find("a"),
                    r = function(a) {
                        q.closest("span").removeClass(v).eq(a).addClass(v)
                    }
                    ;
                a.auto && (t = function() {
